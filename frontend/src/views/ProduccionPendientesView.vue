...
const getLotes = async(page: number) => {
    ...
    if(data.value) {
        ...
        lastPage.value = lotesPendientes.value.meta.last_page
    ...
    <GenericContainer>
        ...
        <template #content>
            <Transition name="fade-content" mode="out-in">
                ...
                <div v-else-if="!lotesPendientes || !lotesPendientes.data || lotesPendientes.data.length === 0" 
                ...
                class="flex flex-col size-full justify-start items-center">
                        <LoteItemCard v-for="(l, i) in lotesPendientes.data"
                        :grids="5"
                        :item="l"
